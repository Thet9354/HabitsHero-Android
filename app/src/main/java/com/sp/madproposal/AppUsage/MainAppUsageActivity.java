...
public class MainAppUsageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_app_usage);
    ...
    private void showAppListAndSetClickListener() {
        ...
        AppInfoListAdapter appInfoListAdapter = new AppInfoListAdapter(MainAppUsageActivity.this, appInfoList);
        appListView.setAdapter(appInfoListAdapter);

        appListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, final int i, long l) {
                Intent intent = new Intent(MainAppUsageActivity.this, AppInfoActivity.class);
